...
public class SingleChoiceDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
       final String[] colors;
        ...
        colors=getResources().getStringArray(R.array.array_sex);
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle("Sex List")
                .setSingleChoiceItems(R.array.array_sex, -1, new DialogInterface.OnClickListener() {
                    @Override
